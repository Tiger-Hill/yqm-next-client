...
export const initialState = {
  basket: typeof window !== "undefined" && JSON.parse(localStorage.getItem("YQM-basket")) || [], // ? ARRAY
  notification: {
    status: "success",
    title: "Success",
...
const basketSlice = createSlice({
  ...
  reducers: {
    ...
    addToBasket: (state, action) => {
      ...
      typeof window !== "undefined" && localStorage.setItem("YQM-basket", JSON.stringify(state.basket));
    },
