...
const orderSlice = createSlice({
  ...
  reducers: {
    ...
    setOrders: (state, action) => {
      ...
      // // ! Groupes the order by orderReferenceNumber. This is setup when the user pays for the order that could include multiples items
      // const groupedOrders = Object.groupBy(action.payload.data, order => order.attributes.orderReferenceNumber);
